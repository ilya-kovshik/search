...
export class SearchDatalistComponent extends HTMLElement {
	...
	private getSelectedList(): HTMLElement {
		return this.shadow.querySelector(`#${SearchDatalistComponent.templateConfig.selectedListId}`) as HTMLElement;
	}
	...
	private getClearSelectionButton(): HTMLElement {
		return this.shadow.querySelector(`.${SearchDatalistComponent.templateConfig.ctrlButtons}__clear-selection`) as HTMLElement;
	}
