...
export class SearchInputComponent extends HTMLElement {
		...
		this.addEventListener("windowClickEvent", () => {
			window.addEventListener("click", (e: Event) => {
				...
				if(
					...
					this.shadow.getElementById(SearchInputComponent.templateConfig.datalistId)?.classList.remove("active");
	...
	private getSelectedList(): HTMLElement {
		return this.shadow.querySelector(`#${SearchInputComponent.templateConfig.selectedListId}`) as HTMLElement;
	}

	private getDataList(): HTMLElement {
		return this.shadow.querySelector(`#${SearchInputComponent.templateConfig.datalistId}__ul`) as HTMLElement;
	}
	...
	private getDataListInput(): HTMLInputElement {
		return this.shadow.querySelector(`#${SearchInputComponent.templateConfig.datalistId}__input`) as HTMLInputElement;
    }
    private clearDataList(): void {
		this.getDataList().innerHTML = "";
	}
	private getShowButton(): HTMLElement {
		return this.shadow.querySelector(`.${SearchInputComponent.templateConfig.ctrlButtons}__show`) as HTMLElement;
	}
	private getHideButton(): HTMLElement {
		return this.shadow.querySelector(`.${SearchInputComponent.templateConfig.ctrlButtons}__hide`) as HTMLElement;
	}
	...
	private getClearSelectionButton(): HTMLElement {
		return this.shadow.querySelector(`.${SearchInputComponent.templateConfig.ctrlButtons}__clear-selection`) as HTMLElement;
	}
